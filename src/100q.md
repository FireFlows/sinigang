...
<dd>I started this website in August 2020, but I didn't really touch it until February 2026.</dd>
...
<dd>I try to go for minimalism.</dd>
...
<dd>Default program for coding on Windows</dd>
...
<dd>Yes, I keep backups of everything.</dd>
...
<dd>My website is currently monochrome with a pop of red ( and purple). This is on purpose.</dd>
...
<dd>I'm working very diligently on it, so I've tried to update it every day. As work slows down, I might change that to once per week instead.</dd>
...
<dd>I don't know, I'm not good enough at HTML/CSS to be an authority on that. I don't like iframes that much, but that's just a personal issue.</dd>
...
<dd>I hate autoplay. It's evil. Don't do it. Actually, changing my answer for #50: DO NOT USE AUTOPLAY FOR YOUR WEBSITE. Not only is it an accessibility issue, I don't want to be interrupted while I am listening to my music! YOUR MUSIC IS NOT AS IMPORTANT AS MINE.</dd>
...
<dd>I'm not familiar with those kinds of layouts (I don't think).</dd>
...
<dd>If there's something cool in their website that I want to steal, I do.</dd>
...
<dd>I use rem for most things, and px for text sizes.</dd>

<dt>80. Do you have a favourite font?</dt>
<dd>I like Arial and general sans-serif fonts. </dd>
...
<dd>It depends on what it is. Right now, I'm directly writing onto the editor, but for things like blog posts I usually write in Ellipsus and then copy it over to the editor.</dd>
